...
df_all_timesteps.to_csv('CT-LSTM(50x50)(82-100hrs).csv', index=False)
...
csv_filename = 'ct_50_82_loss_data.csv'
...
plot_filename = f'{labels[i]}(t=82 to t=100)(time series plot)(50-ct-82).png'
plot_path = os.path.join(output_dir, plot_filename)
plt.savefig(plot_path)
plt.show()