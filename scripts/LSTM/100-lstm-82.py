...
df_all_timesteps.to_csv('LSTM(100x100)(82-100hrs).csv', index=False)


train_loss = history.history['loss'][1:600]
val_loss = history.history['val_loss'][1:600]

output_dir = 'plots(100x100)/plots-LSTM'
...
csv_filename = 'lstm_100_82_loss_data.csv'
...
plot_filename = f'{labels[i]}(t=82 to t=100)(time series plot)(100-lstm-82).png'
plot_path = os.path.join(output_dir, plot_filename)
plt.savefig(plot_path)
plt.show()