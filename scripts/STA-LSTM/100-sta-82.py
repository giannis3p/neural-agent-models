...
df_all_timesteps.to_csv('STA-LSTM(100x100)(82-100hrs).csv', index=False)
...
csv_filename = 'sta_100_82_loss_data.csv'
...
plot_filename = f'{labels[i]}(t=82 to t=100)(time series plot)(100-sta-82).png'
plot_path = os.path.join(output_dir, plot_filename)
plt.savefig(plot_path)
plt.show()