...
df_all_timesteps.to_csv('STA-LSTM(50x50)(82-100hrs).csv', index=False)


train_loss = history.history['loss'][1:600]
val_loss = history.history['val_loss'][1:600]

output_dir = 'plots(50x50)/plots-STA-LSTM'
...
csv_filename = 'sta_50_82_loss_data.csv'
...
plot_filename = f'{labels[i]}(t=82 to t=100)(time series plot)(50-sta-82).png'
plot_path = os.path.join(output_dir, plot_filename)
plt.savefig(plot_path)
plt.show()